                        ...
                        <tr>
                            ...
                            <td class="book-details book-details-wide booklist-panel">
                                <div>
                                    ...
                                    @else
                                    <img src="{{ asset('uploads/default_book_cover.jpg') }}" alt="Default book Cover" class="book-cover-item">
                                    @endif
                                    <br>
                                    <p>{{ $book->category }}</p>
                                    ...
                                    <button type="button" class="btn btn-success detailsButton" data-title="{{ $book->title }}" data-description="{{ $book->description }}">Details</button>
